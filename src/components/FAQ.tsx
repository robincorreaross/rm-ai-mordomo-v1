...
export const FAQ = () => {
  const faqs = [
    {
      question: "O GasteiQuanto é gratuito?",
      answer: "Sim! O GasteiQuanto oferece um plano gratuito completo com recursos essenciais para controle financeiro. Você pode fazer upgrade para planos pagos quando precisar de recursos avançados."
    },
    {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Tire suas dúvidas sobre o GasteiQuanto
          </p>
        </div>

  ...
  const testimonials = [
    {
      name: "Maria Silva",
      role: "Empresária",
      content: "O GasteiQuanto transformou como eu gerencio minhas finanças. Agora tenho controle total sobre meus gastos e receitas.",
      rating: 5,
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Milhares de pessoas já transformaram suas finanças com o GasteiQuanto
          </p>
        </div>
